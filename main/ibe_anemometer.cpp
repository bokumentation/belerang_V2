...
unsigned long timemeasure = 10.00; // detik, changed from 10.00
int timetoSleep = 1;							 // menit
unsigned long sleepTime = 15;			 // menit
unsigned long timeNow;
int countThing = 0;
int GPIO_pulse = 32;							 // ESP32 = D32, original pin 14
...
void anemometer_loop()
{
	...
	// Tambahkan delay kecil untuk mencegah watchdog trigger
	delay(1);
} // end of loop